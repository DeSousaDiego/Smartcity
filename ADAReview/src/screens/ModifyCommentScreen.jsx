...
import { modifyComment as modifyCommentStore} from '../store/commentSlice';
...
const ModifyCommentScreen = ({ route }) => {
  ...
  const modifyComment = () => {
    const commentUpdate = {id : comment.id, content, review_id: comment.review_id, user_id: comment.user_id};
    if(content === ''){
        ...
        [
          ...
          { text: "Valider", onPress: () => {
            try{
              ...
              dispatch(modifyCommentStore(commentUpdate));
  ...
  return (
    ...
    >
      ...
      <ScrollView style={commentFormStyles.container}>
        ...
        <TouchableOpacity style={commentFormStyles.submitButton} onPress={modifyComment}>
