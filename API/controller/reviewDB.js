...
module.exports.addlike = async (req, res) => {
    if(req.session !== undefined){
        ...
        const client = await pool.connect();
        try{
            await ReviewModel.addlike(client, id);
            res.sendStatus(204);
        } catch (error){
            console.error(error);
            res.sendStatus(500);
...
module.exports.removelike = async (req, res) => {
    if(req.session !== undefined){
        ...
        const client = await pool.connect();
        try{
            await ReviewModel.removelike(client, id);
            res.sendStatus(204);
        } catch (error){
            console.error(error);
            res.sendStatus(500);
...
module.exports.addDislike = async (req, res) => {
    if(req.session !== undefined){
        ...
        const client = await pool.connect();
        try{
            await ReviewModel.addDislike(client, id);
            res.sendStatus(204);
        } catch (error){
            console.error(error);
            res.sendStatus(500);
...
module.exports.removeDislike = async (req, res) => {
    if(req.session !== undefined){
        ...
        const client = await pool.connect();
        try{
            await ReviewModel.removeDislike(client, id);
            res.sendStatus(204);
        } catch (error){
            console.error(error);
            res.sendStatus(500);
