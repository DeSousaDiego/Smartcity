...
router.get('/', JWTMiddleWare.identification, reviewController.getAllReview);
...
]) , JWTMiddleWare.identification, AuthoMiddleware.mustBeAdmin, reviewController.postReview);
...
router.patch('/:id', upload.fields([
    ...
    {name:"user_id", maxCount :1},
    {name:"book_id", maxCount :1}
]) , JWTMiddleWare.identification, AuthoMiddleware.mustBeAdmin, reviewController.updateReview);
...
router.delete('/:id', JWTMiddleWare.identification, AuthoMiddleware.mustBeAdmin, reviewController.deleteReview);
