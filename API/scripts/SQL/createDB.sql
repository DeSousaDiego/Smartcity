...
-- Writers and editors roles
    ('author', '978-2-1234-5680-3', 1),
    ('author', '978-2-1234-5681-0', 1),
    ('author', '978-0-4515-2493-5', 2),
    ('author', '978-2-1234-5682-7', 3),
...
CREATE TABLE review(
    ...
    dislikes_counter integer NOT NULL,
...
('Tu as vraiment raison ! Mais je trouve que le livre est un peu trop long', '2021-04-01 12:00:00', 0, 0, 1, 1),
('Je ne suis pas d accord avec toi, je trouve que le livre est très bien', '2021-04-01 12:00:00', 0, 0, 1, 1),
('Je suis d accord avec toi, le livre est vraiment trop long', '2021-04-01 12:00:00', 0, 0, 2, 3),
...
('Je suis d accord avec toi, le livre est vraiment trop long', '2021-04-01 12:00:00', 0, 0, 8, 3),
('Je suis d accord avec toi, le livre est vraiment trop long', '2021-04-01 12:00:00', 0, 0, 9, 3);
