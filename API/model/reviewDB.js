...
module.exports.getAllReviews = async (client) => {
    ...
    `SELECT r.id, r.title, r.content, r.rating, r.likes_counter, r.dislikes_counter, r.book_id, 
...
module.exports.addlike = async (client, id) => {
    return await client.query("UPDATE review SET likes_counter = likes_counter + 1 WHERE id = $1", [id]);
};
...
module.exports.addDislike = async (client, id) => {
    return await client.query("UPDATE review SET dislikes_counter = dislikes_counter + 1 WHERE id = $1", [id]);
};
