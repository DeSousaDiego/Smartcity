...
const addLike = async (id, token) => {
  try{
    return await axios.patch(`${commentURL}/like/${id}`, {}, {
        headers: {
          'Authorization': 'Bearer ' + token,
          'Accept-Version': versionNumber
        }
...
const removeLike = async (id, token) => {
  try {
    return await axios.patch(`${commentURL}/removeLike/${id}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + token,
        'Accept-Version': versionNumber
      }
...
const addDislike = async (id, token) => {
  try {
    return await axios.patch(`${commentURL}/dislike/${id}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + token,
        'Accept-Version': versionNumber
      }
...
const removeDislike = async (id, token) => {
  try {
    return await axios.patch(`${commentURL}/removeDislike/${id}`, {}, {
      headers: {
        'Authorization': 'Bearer ' + token,
        'Accept-Version': versionNumber
      }
...
export {sendForm, getComment, getCommentsFromIdReview, deleteComment, updateComment, addLike, removeLike, addDislike, removeDislike};