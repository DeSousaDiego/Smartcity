...
import { Button, ActivityIndicator, Text, View, TextInput, TouchableOpacity, Alert, BackHandler } from "react-native";
        ...
        {isLoading ? (
          ...
          <>
            ...
            <View style={LoginStyles.rectangleContainer}>
              ...
              {showMessage && <Text style={LoginStyles.messageText}>On va vers la page register</Text>}
            </View>
