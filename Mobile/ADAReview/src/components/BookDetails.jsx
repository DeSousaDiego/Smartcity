...
function BookDetails({book, navigation}){
    ...
    return(
        ...
        <View style={bookDetailsstyles.content}>
          <Image source={imageSource} style={bookDetailsstyles.image} resizeMode="contain"/>
          ...
          <AirbnbRating showRating={false} size={20} defaultRating={book.rating} isDisabled={true} />
