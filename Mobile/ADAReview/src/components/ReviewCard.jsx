...
const ReviewCard = ({ item, textColor, type }) => {
  ...
  if(type === 'bookPresentation'){
    imgPath = "http://192.168.1.7:3001/images/" + (item.account_img_path ? item.account_img_path : 'unknown.jpeg');
    ...
    imgPath = "http://192.168.1.7:3001/images/" + (item.book_img_path ? item.book_img_path : 'unknownBook.jpeg');
    imgSource = { uri: imgPath };
    return (
      <View style={cardStyle.detailsContainer}>
