...
import { addLike, removeLike, addDislike, removeDislike } from '../API/review';
         ...
         <Image source={imgSource} style={cardStyle.reviewImage}/>
          <View style={cardStyle.textContainer}>
            ...
            <View style={cardStyle.likeDislikeContainer}>
              ...
              <Text style={[{ fontSize: 25, padding: 10 }, isLiked && { backgroundColor: '#354F52' }]}>👍</Text>
              </TouchableOpacity>
              <Text style={cardStyle.voteCount}>{item.likes_counter - item.dislikes_counter}</Text>
              <TouchableOpacity onPress={handleDislike}>
              <Text style={[{ fontSize: 25, padding: 10 }, isDisliked && { backgroundColor: '#354F52' }]}>👎</Text>
              </TouchableOpacity>
            </View>
        </View>
